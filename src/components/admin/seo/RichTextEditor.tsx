...
export function RichTextEditor({
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-neutral-300 bg-white">
      ...
      <div className="flex flex-nowrap items-center gap-1 overflow-x-auto border-b border-neutral-200 bg-neutral-50 p-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        <select
